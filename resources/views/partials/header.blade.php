<header class="fbs__net-navbar navbar navbar-expand-lg dark" aria-label="freebootstrap.net navbar">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <a class="navbar-brand w-auto" href="{{ route('welcome') }}">
            ...
            <!-- logo dark--><img class="logo dark img-fluid" src="{{ asset('images/logo-dark.svg') }}" alt="Nova Logo">

            <!-- logo light--><img class="logo light img-fluid" src="{{ asset('images/logo-light.svg') }}"
                alt="Nova Logo">
        ...
        <div class="offcanvas offcanvas-start w-75" id="fbs__net-navbars" tabindex="-1"
            ...
            <div class="offcanvas-header">
                <div class="offcanvas-header-logo">
                    ...
                    <!-- h5#fbs__net-navbarsLabel.offcanvas-title Nova-->

                    <!-- If you plan to use an image logo, uncomment this if it is commented-->
                    <a class="logo-link" id="fbs__net-navbarsLabel" href="{{ route('welcome') }}">

                        <!-- logo dark--><img class="logo dark img-fluid" src="{{ asset('images/logo-dark.svg') }}"
                            alt="Nova Logo">
