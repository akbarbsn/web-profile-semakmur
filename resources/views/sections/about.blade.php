...
<section class="about__v4 section" id="about">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6"> 
        <div class="img-wrap position-relative"><img class="img-fluid rounded-4" src="{{ asset('images/about_2-min.jpg') }}" alt="About us image" data-aos="fade-up" data-aos-delay="0">
