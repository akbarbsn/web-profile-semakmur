            ...
            <div class="col-lg-6 mb-4 mb-lg-0">
                <div class="row">
                    <div class="col-lg-11"><span class="hero-subtitle text-uppercase" data-aos="fade-up"
                        ...
                        <p class="hero-description mb-4 mb-lg-5" data-aos="fade-up" data-aos-delay="200">Experience the
                            future of finance with our secure, efficient, and user-friendly financial services.</p>
                        ...
                        <div class="logos mb-4" data-aos="fade-up" data-aos-delay="400"><span
                            ...
                            <div class="logos-images d-flex gap-4 align-items-center"><img
                                    ...
                                    src="{{ asset('images/logo/actual-size/logo-air-bnb__black.svg') }}" alt="Company 1"
                                    style="width: 110px;"><img class="img-fluid js-img-to-inline-svg"
                                    src="{{ asset('images/logo/actual-size/logo-ibm__black.svg') }}" alt="Company 2"
