            ...
            <div class="col-lg-6 mb-4 mb-lg-0">
                <div class="row">
                    <div class="col-lg-11"><span class="hero-subtitle text-uppercase" data-aos="fade-up"
                            data-aos-delay="0">Marketplace Ekspor Indonesia</span>
                        <h1 class="hero-title mb-3" data-aos="fade-up" data-aos-delay="100">Semakmur Menghubungkan
                            Produk Indonesia dengan Dunia</h1>
